  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        </div>        {/* Fun Content - Side by Side Layout */}
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div 
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(200, 230, 201, 0.8) 0%, rgba(215, 204, 200, 0.6) 100%)',
                backdropFilter: 'blur(15px)',
                boxShadow: '8px_8px_24px_rgba(176,217,176,0.3),-8px_-8px_24px_rgba(255,255,255,0.8)',
            ...
            >
              ...
              <div className="absolute bottom-4 right-4 opacity-15">
                <Coffee className="w-6 h-6 text-secondary animate-bounce" style={{ animationDelay: '0.5s' }} />
              </div>
              ...
              <div className="relative z-10 text-center w-full">
                ...
                <div className="font-ml text-lg md:text-xl leading-relaxed space-y-3">
                  <div className="text-text-primary font-medium">
                    Have a curiosity? Have a <span className="font-bold text-primary">task</span>?
                  </div>
                  <div className="text-text-muted">
                    Have a gig, need or <span className="font-semibold text-text-primary">ask</span>?
                  </div>
                  <div className="text-text-muted">
                    I guess it will do no <span className="font-semibold text-text-primary">harm</span>
                  </div>
                  <div className="font-q font-bold text-primary text-xl md:text-2xl">
                    To put a call right to <span className="text-2xl md:text-3xl">Afam</span>
                  </div>
                </div>
            ...
            <div 
              className="p-8 md:p-10 rounded-3xl transition-all duration-500 hover:scale-[1.02] relative overflow-hidden h-full flex items-center"
              style={{
                background: 'linear-gradient(135deg, rgba(215, 204, 200, 0.7) 0%, rgba(200, 230, 201, 0.8) 100%)',
                backdropFilter: 'blur(15px)',
                boxShadow: '8px_8px_24px_rgba(176,217,176,0.3),-8px_-8px_24px_rgba(255,255,255,0.8)',
            ...
            >
              ...
              <div className="absolute top-4 right-4 opacity-15">
                <Code className="w-8 h-8 text-accent animate-pulse" style={{ animationDelay: '1s' }} />
              </div>
              <div className="absolute bottom-4 left-4 opacity-15">
                <Zap className="w-6 h-6 text-primary animate-bounce" style={{ animationDelay: '1.5s' }} />
              </div>
              ...
              <div className="relative z-10 text-center w-full">
                ...
                <div className="mt-6 flex justify-center">
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="text-xs text-text-muted font-ml">quantum uncertainty</div>
                    <div className="w-3 h-3 rounded-full bg-primary/40 animate-pulse" style={{ animationDelay: '1s' }}></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {socialLinks.map((social) => {
              ...
              return (
                <Link
                  ...
                  style={{
                    background: 'linear-gradient(135deg, rgba(200, 230, 201, 0.6) 0%, rgba(215, 204, 200, 0.5) 100%)',
                    backdropFilter: 'blur(10px)',
                    boxShadow: '4px_4px_12px_rgba(176,217,176,0.2),-4px_-4px_12px_rgba(255,255,255,0.6)',
                  }}
                ...
                >
                  <div className="flex flex-col items-center space-y-3">
                    ...
                    <div className="text-center">
                      <h4 className="font-q font-semibold text-sm">{social.name}</h4>
                      <p className="font-ml text-xs text-text-muted mt-1">{social.description}</p>
                    </div>
                  </div>
                  ...
                  <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                    style={{
                      background: 'linear-gradient(135deg, rgba(200, 230, 201, 0.8) 0%, rgba(215, 204, 200, 0.7) 100%)',
                      boxShadow: '8px_8px_24px_rgba(176,217,176,0.4),-8px_-8px_24px_rgba(255,255,255,0.9)'
                    }}
                  />
                </Link>
              );
        ...
        <div className="relative">
          <Link
            ...
            style={{
              background: 'linear-gradient(135deg, #43766c 0%, #a2d6cc 100%)',
              color: 'white',
              boxShadow: '6px_6px_20px_rgba(67,118,108,0.4),-6px_-6px_20px_rgba(255,255,255,0.1)',
            }}
          >
          ...
          <div className="absolute -inset-4 pointer-events-none">
            <div className="absolute top-0 left-0 w-3 h-3 rounded-full bg-primary/20 animate-bounce" style={{ animationDelay: '0s' }}></div>
            <div className="absolute top-0 right-0 w-2 h-2 rounded-full bg-secondary/30 animate-bounce" style={{ animationDelay: '0.5s' }}></div>
            <div className="absolute bottom-0 left-0 w-2 h-2 rounded-full bg-accent/20 animate-bounce" style={{ animationDelay: '1s' }}></div>
            <div className="absolute bottom-0 right-0 w-3 h-3 rounded-full bg-primary/15 animate-bounce" style={{ animationDelay: '1.5s' }}></div>
          </div>
        </div>

        {/* Fun Footer */}
        <div className="mt-12">
          <p className="font-ml text-sm text-text-muted">
            ☕ Currently powered by coffee and curiosity
          </p>
        </div>
      </div>
    </section>
